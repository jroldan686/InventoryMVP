...
import jrl.deint.inventory.pojo.User;
...
public class UserRepository {
    ...
    private static jrl.deint.inventory.repository.UserRepository userRepository;

    /* INICIALIZACIÓN */
/* Inicializar todos los atributos de ámbito estático o de clase */
    static {
        userRepository = new jrl.deint.inventory.repository.UserRepository();
    }
    ...
    /* Patrón Singletón */
    public static jrl.deint.inventory.repository.UserRepository getInstance() {
